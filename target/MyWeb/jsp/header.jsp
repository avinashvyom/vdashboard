	...
	<nav class="navbar navbar-default">
		<div class="container-fluid">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#"><img src="images/vyomlabs1.png"
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav">
					...
					<li><a href="dashboard.do?pType=new&nsec=<%=nsec%>"><span><img
								src="images/pie.png"></span> Dashboard</a></li>
					<%
						if (userDto.getRole().equals("Admin")) {
					%>
					<li><a href="createProcess.do?nsec=<%=nsec%>&msg=&str="><span><img
								src="images/gear.png"></span> Register Process</a></li>
	         	 ...
	         	 <li><a href="updateUser.do?nsec=<%=nsec%>&msg= &userName=New"><span><img src="images/user1.png"></span> User Updation</a></li> --%>
					<li class="dropdown"><a href="javascript:void(0)"
						class="dropbtn"><span><img src="images/user1.png"></span>
							User</a>
