...
<link href="css/smoothness/popup-jquery-ui.css" rel="stylesheet"
	type="text/css">
...
<%
	...
	//System.out.println("From header2.jsp page " + userDto.toString());
%>
		...
		<div class="container-fluid">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#"><img
					src="images/vyomlabs-logo.png" alt="Avatar" class="avatar"></a>
	      ...
	      <li class="logo">
		        <a href="#">
		          <img src="https://www.vyomlabs.com/wp-content/uploads/2017/03/vyomlabs-Logo.png"></a>
					...
					<li><a href="dashboard.do?pType=new&nsec=<%=nsec%>"><span><img
								src="images/Dashboard.png" style="height: 20px;"></span>
							Dashboard</a></li>
					<%
						if (userDto.getRole().equals("Admin")) {
					%>
					<li><a href="createProcess.do?nsec=<%=nsec%>&msg=&str="><span><img
								src="images/RegisterProcess.png"
								style="height: 20px; color: #333; font-weight: 600;"></span>
							Register Process</a></li>
	         	 ...
	         	 <li><a href="updateUser.do?nsec=<%=nsec%>&msg= &userName=New"><span><img src="images/user1.png"></span> User Updation</a></li> --%>
					<li class="dropdown"><a href="javascript:void(0)"
						class="dropbtn"><span><img src="images/UserImg.png"
								style="height: 20px;"></span> User</a>
						<div class="dropdown-content">
							<a href="createUser.do?nsec=<%=nsec%>&msg="><span><img
									src="images/user1.png"></span> Create User</a> <a
								href="updateUser.do?nsec=<%=nsec%>&msg= &userName=New"><span><img
									src="images/user1.png"></span> Update User</a>

						</div></li>
							<li><a href="displayAuditData.do?pType=${pType}&nsec=<%=nsec%>"><span
							class="glyphicon glyphicon-th" aria-hidden="true"></span> Audit</a></li>
							<%-- &pType=${pType} nsec=<%=nsec%>--%>
...
<!-- 					</li> -->
					...
					<li><a href="logout.do?nsec=<%=nsec%>"><span><img
								src="images/5.png" style="height: 20px;"></span> Logout</a></li>
				</ul>
			</div>
			<!-- /.navbar-collapse -->
		</div>
