...
public interface ProcessService {
	...
	public String createProcessMetaData(String userNme, String processName, String[] fieldName, String[] dataType,
			String[] length) throws Exception;

	public Map<String, Object> viewProcessByID(Integer pID, String name) throws Exception;

	public List<ProcessDto> listProcessData(String id, String status) throws Exception;
	...
	void updateProcess(String userName, MultiValueMap<String, String> requestParams) throws Exception;

	List<Map<String, Object>> getProcessColumns(String pType) throws Exception;

	ModelAndView sendAuditData(String pType, UserDto userDto) throws SQLException;
