	...
	public Integer updateUser(UserDto userDto, List<String> processList) throws Exception {
		...
		try {
			...
			if (!colNames.isEmpty()) {
				 ...
				 * createPreparedStatement(final Connection connection) throws
				 * SQLException { final PreparedStatement ps =
				 * connection.prepareStatement(updateQuery); return ps; } };
				 */
